...
function toggleQuoteModal(show) {
  if (show) {
    ...
    if (typeof resetModalQuoteForm === 'function') resetModalQuoteForm();
  }
}
window.toggleQuoteModal = toggleQuoteModal;
